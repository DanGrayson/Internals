...
celltype = new HashTable from {
    ...
    "MonomialIdeal" => hashTable {
        DType => "RawMonomialIdealCell",
        Synonym => "a raw monomial ideal", 
        Suffix => ".p"
        },
    "MonomialIdealOrNull" => hashTable {
        DType => "RawMonomialIdealOrNull",
        Synonym => "a raw monomial ideal or null", 
        Suffix => ".p"
        },
    "Monoid" => hashTable {
        DType => "RawMonoidCell",
...
result = str (genFunctionCall(
        "rawAlexanderDual", 
        "MonomialIdealOrNull", 
        ("a"=>"MonomialIdeal", "b"=>"intarray", "c"=>"int")
        ))
